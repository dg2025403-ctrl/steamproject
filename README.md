...
[Kaggle의 Steam 빅데이터(출처)](https://www.kaggle.com/datasets/fmpugliese/steam-all-games-data)를 활용하여 게임 시장의 다양한 상관관계를 분석하고 시각화하는 데이터 탐구 중심의 Web Dashboard 프로젝트입니다. 학교 수행평가 제출 및 Streamlit Cloud 배포를 목적으로 최적화되었습니다.

---

## 📌 1. 프로젝트 소개 & 목표
본 프로젝트는 단순한 게임 소개나 순위 나열을 넘어, [Kaggle Steam All Games Data](https://www.kaggle.com/datasets/fmpugliese/steam-all-games-data) 마켓 데이터를 기반으로 가격, 평점, 할인율, 플레이 타임 등이 실제 게임의 '흥행(판매량)'에 어떤 영향을 미치는지 통계적으로 분석합니다. Netflix와 Steam의 다크 모드 감성을 결합한 UI 디자인과 대용량 데이터 처리 기법을 적용했습니다.

## 👥 2. 팀원 소개
* **20802 김단우** - 데이터 전처리, 통계 분석 및 대시보드 구현
* **20216 이서현** - 데이터 시각화, UI/UX 디자인 및 성능 최적화
